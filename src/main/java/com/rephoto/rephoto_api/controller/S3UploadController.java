...
import com.rephoto.rephoto_api.dto.S3UploadResponseDto;
...
public class S3UploadController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "파일 업로드 성공 - S3 URL 반환",
                    content = @Content(schema = @Schema(implementation = S3UploadResponseDto.class))),
            @ApiResponse(responseCode = "400", description = "파일이 비어있거나 크기 초과 또는 지원하지 않는 파일 형식", content = @Content),
