...
public class AlbumController {
    ...
    public ResponseEntity<List<AlbumResponseDto>> list(@PathVariable Long userId) {
    ...
    public ResponseEntity<AlbumResponseDto> search(
        ...
        return ResponseEntity.ok(albumService.getAlbumBySearch(userId, tag));
    }
    ...
    public ResponseEntity<List<PhotoResponseDto>> getAlbumPhotos(
        ...
        return ResponseEntity.ok(photoService.getPhotosByUserAndTag(userId, tagId));
    }
}
